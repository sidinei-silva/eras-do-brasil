...
## 8. Regras de combate e o modelo de disparo

**Não há tick.** O próximo evento é o menor entre o próximo ataque básico e a próxima habilidade pronta. A luta inteira é resolvida de uma vez e enviada como linha do tempo com marcações em segundos.
...
Cada uma tem **recarga** e **custo de energia**. Dispara quando está pronta e há energia.
...
Tags ajustam: área e cura encarecem e alongam, controle e fuga alongam mais.
...
Seis slots ativos ordenados pelo jogador. Quando mais de uma habilidade está pronta e há energia, **dispara a de prioridade mais alta**. Não há lista de desabilitadas — o slot já é a restrição.

### Ordem de verificação

A cada evento: condição de parada, limiar de retirada, limiar de cura, disparar. Poção sai por limiar de vida e fica fora da prioridade.
