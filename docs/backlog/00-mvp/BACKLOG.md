# Backlog — MVP de Eras do Brasil

> Este arquivo é o índice e o planejamento do MVP. O detalhe de cada fatia
> fica no próprio arquivo da fatia.

A fatia é a unidade pequena de trabalho do MVP. Quando uma fatia estiver
decidida, suas tarefas podem ser transformadas em issues dentro de um
Milestone correspondente no GitHub.

## Escopo do MVP

O MVP corresponde à experiência completa de **A Travessia**. Sua construção
